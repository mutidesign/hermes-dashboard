...
layout: docs
title: Dropdowns
description: We are very proud to present the dropdown, we added a subtle animation for this classic widget.
group: components
toc: true
---
...
For more details and options please check the [Bootstrap Official Documentation](https://getbootstrap.com/docs/4.0/components/dropdowns/)