    ...
    t.cleanData = function(e) {
        ...
        t.fn[e] = function(o) {
            ...
            return a ? this.each(function() {
                ...
                return "instance" === o ? (h = n, !1) : n ? t.isFunction(n[o]) && "_" !== o.charAt(0) ? (i = n[o].apply(n, r), i !== n && void 0 !== i ? (h = i && i.jquery ? h.pushStack(i.get()) : i, !1) : void 0) : t.error("no such method '" + o + "' for " + e + " widget instance") : t.error("cannot call methods on " + e + " prior to initialization; " + "attempted to call method '" + o + "'")
        ...
        function() {
            ...
            t.position = {
                    ...
                    return b = s(y), y[0].preventDefault && (n.at = "left top"), m = b.width, g = b.height, v = b.offset, _ = t.extend({}, v), t.each(["my", "at"], function() {
                        ...
                        "right" === n.my[0] ? S.left -= c : "center" === n.my[0] && (S.left -= c / 2), "bottom" === n.my[1] ? S.top -= d : "center" === n.my[1] && (S.top -= d / 2), S.left += M[0], S.top += M[1], o || (S.left = h(S.left), S.top = h(S.top)), s = {
                            marginLeft: f,
                            marginTop: b
